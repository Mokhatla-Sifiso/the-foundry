...
export function Chat({ className }: IconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth={1.8} {...ROUND} className={className} aria-hidden="true">
...
export function Arrow({ className }: IconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth={2} {...ROUND} className={className} aria-hidden="true">
...
export function IconLock({ className }: IconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} {...ROUND} className={className} aria-hidden="true">
...
export function IconMail({ className }: IconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...ROUND} className={className} aria-hidden="true">
...
export function IconCheck({ className }: IconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={3} {...ROUND} className={className} aria-hidden="true">
