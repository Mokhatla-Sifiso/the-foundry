...
export default function CookiePage(): React.ReactElement {
  return (
    <LegalLayout title="Cookie Policy" version={COOKIE_POLICY_VERSION} updatedAt="23 June 2026">
      ...
      <p>
        Every cookie and browser-storage key this site sets is listed below. The list is
        rendered directly from the same inventory the consent banner uses, so the policy
        cannot drift from reality. If you find something on your machine that isn&apos;t in the
        table, it isn&apos;t from us.
      </p>
      ...
      <p>
        Click <strong>&ldquo;Cookie preferences&rdquo;</strong> in the footer at any time to
        reopen the consent banner. Withdrawing consent does not retroactively erase data we
        already had your permission to process &mdash; see the{" "}
